...
<body>
 <jsp:include page="../common/menubar.jsp"/>
        <div>
            <h4 style="display: inline-block;" style="float: left;"><b>결재 문서함</b></h4>
            <div align="right">
        ...
        <c:if test="${ not empty list}">
            ...
            <c:choose>
            	...
            	<c:otherwise>
             	   <li class="page-item"><a class="page-link" href="signlist.app?cpage=${ pi.currentPage-1 }">Previous</a></li>
                </c:otherwise>
            </c:choose>
            
           	<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
        		<li class="page-item"><a class="page-link" href="signlist.app?cpage=${ p }">${ p }</a></li>
        	</c:forEach>
            ...
            <c:choose>
         		<c:when test="${ pi.currentPage eq pi.maxPage }">
          		...
          		<c:otherwise>
          			<li class="page-item"><a class="page-link" href="signlist.app?cpage=${ pi.currentPage+1 }">Next</a></li>
          		</c:otherwise>
        	</c:choose>
              </ul>
        </c:if>
